  ...
  return (
    <div className="w-full max-w-2xl mx-auto flex flex-col justify-center min-h-[60vh]">
      <div className="bg-white p-10 rounded-3xl border border-red-100 shadow-xl text-center">
        ...
        <h2 className="text-3xl font-bold text-red-700 mb-4">Please call for help right now.</h2>
        <p className="text-slate-600 text-lg mb-10">We detected you might be in immediate danger.</p>
